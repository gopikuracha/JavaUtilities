...
public class TestArrayListTDS {
	...
	public void testRowFeatures() {
		...
		// Test insertRecord
		String[] rec5 = {"Bobby", "Bidhar", "Bison", "Bell"};
		int rowIndex = 2;
	...
	public void testColumnFeatures() {
		...
		// Test Add New Column
		String[] newCol = {"Country", "India", "China", "Japan", "France", "Italy", "Mexico"};
		System.out.println("Adding New Column: " + newCol[0] + " : " + tds.addNewColumn(Arrays.asList(newCol), -1, true));
		System.out.println(tds);
	...
	public void testCloneTDS() {
		...
		ArrayListTDS tds = getTDS();
		ArrayListTDS tds2 = tds.cloneTDS();
	...
	public ArrayListTDS getTDS() {
		return buildTDS2();
	}
	
	public ArrayListTDS buildTDS1() {
		...
		tds.getRecords().add(new ArrayList<String>(Arrays.asList(rec1)));
		tds.getRecords().add(new ArrayList<String>(Arrays.asList(rec2)));
		tds.getRecords().add(new ArrayList<String>(Arrays.asList(rec3)));
		tds.getRecords().add(new ArrayList<String>(Arrays.asList(rec4)));
		
		return tds;
	}
	
	public ArrayListTDS buildTDS2() {
		String[] headers = {"Name", "City", "Animal", "Thing", "Body Part"};
		...
		tds.getRecords().add(new ArrayList<String>(Arrays.asList(rec3)));
		tds.getRecords().add(new ArrayList<String>(Arrays.asList(rec4)));
		tds.getRecords().add(new ArrayList<String>(Arrays.asList(rec5)));
